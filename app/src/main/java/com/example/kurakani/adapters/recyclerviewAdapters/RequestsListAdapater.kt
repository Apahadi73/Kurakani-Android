...
class RequestListListAdapter(private val RequestList: MutableLiveData<List<Request>>) :
    ...
    class RequestViewHolder private  constructor(val binding: RequestItemCardBinding) : RecyclerView.ViewHolder(binding.root),
        ...
        fun bind(
            ...
            if (currentItem != null) {
                Picasso.get().load(currentItem.imageSrc).into(holder.binding.userCardImage)
            }
            if (currentItem != null) {
